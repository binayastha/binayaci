...
$query_builder = TRUE;
if($_SERVER['HTTP_HOST']=="localhost" || $_SERVER['HTTP_HOST']=="127.0.1.1"|| $_SERVER['HTTP_HOST']=="192.168.0.113")
{
$db['default'] = array(
	'dsn'	=> '',
	'hostname' => 'localhost',
...
{
	$db['default']=array(
	'username'=>'omsnepal_oms',
	'password' => 'O_Wdr!dI.bpQ',
	'database' => 'omsnepal_oms',
	'hostname'=>'localhost',
	'dsn'	=> '',
	'dbdriver' => 'mysqli',
	'dbprefix' => '',
